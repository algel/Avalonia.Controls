...
namespace Algel.Avalonia.Controls
{
    ...
    public class GridSplitter : Thumb
    {
        ...
        {
            var gridSpan = GetValue(_resizeData!.ResizeDirection == GridResizeDirection.Columns ?
            ...
            if (gridSpan == 1)
            {
                ...
                var count = _resizeData.ResizeDirection == GridResizeDirection.Columns ?
                ...
                if (index1 >= 0 && index2 < count)
                {
                    ...
                    var isStar1 = IsStar(_resizeData.Definition1);
                    var isStar2 = IsStar(_resizeData.Definition2);
        ...
        protected override void OnDragDelta(VectorEventArgs e)
        {
            ...
            if (_resizeData != null)
            {
                var horizontalChange = e.Vector.X;
                var verticalChange = e.Vector.Y;

                // Round change to nearest multiple of DragIncrement.
                var dragIncrement = DragIncrement;
        ...
        private void GetDeltaConstraints(out double minDelta, out double maxDelta)
        {
            ...
            var definition1Min = _resizeData.Definition1!.UserMinSizeValueCache;
            var definition1Max = _resizeData.Definition1.UserMaxSizeValueCache;

            var definition2Len = GetActualLength(_resizeData.Definition2!);
            var definition2Min = _resizeData.Definition2!.UserMinSizeValueCache;
            var definition2Max = _resizeData.Definition2.UserMaxSizeValueCache;
        ...
        private void MoveSplitter(double horizontalChange, double verticalChange)
        {
            ...
            if (definition1 != null && definition2 != null)
            {
                ...
                var pixelLength = 1 / _resizeData.Scaling;
                var epsilon = pixelLength + LayoutHelper.LayoutEpsilon;
