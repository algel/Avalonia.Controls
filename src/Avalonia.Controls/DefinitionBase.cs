...
namespace Algel.Avalonia.Controls
{
    ...
    public abstract class DefinitionBase : AvaloniaObject
    {
        ...
        internal static void OnUserSizePropertyChanged(DefinitionBase definition, AvaloniaPropertyChangedEventArgs e)
        {
            ...
            {
                var oldUnitType = ((GridLength)e.OldValue!).GridUnitType;
                var newUnitType = ((GridLength)e.NewValue!).GridUnitType;
        ...
        /// </summary>
        internal GridLength UserSize => (_sharedState != null ? _sharedState.UserSize : UserSizeValueCache);
        ...
        {
            var definition = (DefinitionBase)d;
        ...
        internal class SharedSizeScope
        {
            ...
            internal SharedSizeState EnsureSharedState(string sharedSizeGroup)
            {
                ...
                var sharedState = _registry[sharedSizeGroup] as SharedSizeState;
                if (sharedState == null)
                {
        ...
        internal class SharedSizeState
        {
            ...
            internal void Invalidate()
            {
                ...
                if (_broadcastInvalidation)
                {
                    ...
                    {
                        var parentGrid = (Grid)(_registry[i].Parent!);
            ...
            private void OnLayoutUpdated(object? sender, EventArgs e)
            {
                ...
                var sharedMinSizeChanged = !MathUtilities.AreClose(_minSize, sharedMinSize);
                ...
                for (int i = 0, count = _registry.Count; i < count; ++i)
                {
                    ...
                    var useSharedMinimum = !MathUtilities.AreClose(definitionBase._minSize, sharedMinSize);
